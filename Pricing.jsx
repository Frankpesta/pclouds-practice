...
const Pricing = () => {
  return (
    <div className='w-full text-white my-24' name='pricing'>
      ...
      <div className='max-w-[1240px] mx-auto py-12'>
          <div className='text-center py-8 text-slate-300'>
              ...
              <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur dolorum possimus nulla natus? Asperiores magnam debitis doloremque ea dolore sapiente.</p>

          </div>
          <div className='grid md:grid-cols-2'>
              <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                  <span className='uppercase px-3 py-1 bg-indigo-200 text-indigo-900 rounded-b-2xl text-sm'>Standard</span>
                  <div className=''>
              ...
              <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
                  <span className='uppercase px-3 py-1 bg-indigo-200 text-indigo-900 rounded-b-2xl text-sm'>Premium</span>
                  <div className=''>
